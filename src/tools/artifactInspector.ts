 ...
 */
export async function inspectJar(jarPath: string): Promise<ArtifactInspectionReport> {
 ...
 */
export async function inspectWar(warPath: string): Promise<ArtifactInspectionReport> {
 ...
 */
export async function inspectStaticBundle(
  bundlePath: string,
 ...
 */
export async function inspectNpmPackage(tarballPath: string): Promise<ArtifactInspectionReport> {
 ...
 */
export async function inspectBrowserExtension(
  extPath: string
): Promise<ArtifactInspectionReport> {
  const warnings: string[] = [];
  const errors: string[] = [];
